...
function responsive(maxWidth) {
  if (maxWidth.matches) {
    ...
    $(".product-sec .tab-1").click(function () {
      $(".home-fixed-nav-bar .navbar-brand .sunshine-logo").attr(
        "src",
...
setInterval(function () {
  if ($(".clientParnterAnimation ").hasClass("img-1")) {
    $(".clientParnterAnimation").removeClass("img-1");
    $(".clientParnterAnimation").addClass("img-2");
    $(".clientParnterAnimation").attr("style", "background: url(dist/images/client-partner/bg-gradient-2.png) no-repeat bottom left;");
    $(".clientParnterAnimation img").attr("src", "dist/images/client-partner/2_G.png");
  } else if ($(".clientParnterAnimation ").hasClass("img-2")) {
    $(".clientParnterAnimation").removeClass("img-2");
    $(".clientParnterAnimation").addClass("img-3");
    $(".clientParnterAnimation").attr("style", "background: url(dist/images/client-partner/bg-gradient-3.png) no-repeat bottom left;");
    $(".clientParnterAnimation img").attr("src", "dist/images/client-partner/3_G.png");
  }  else if ($(".clientParnterAnimation ").hasClass("img-3")) {
    $(".clientParnterAnimation").removeClass("img-3");
    $(".clientParnterAnimation").addClass("img-1");
    $(".clientParnterAnimation").attr("style", "background: url(dist/images/client-partner/bg-gradient-1.png) no-repeat bottom left;");
    $(".clientParnterAnimation img").attr("src", "dist/images/client-partner/1_G.png");
  } 
}, 5000);

$(document).ready(function () {

  $('.onSlide02').click(function(){
    console.log("onSlide02");
    $('.webTraffic-data .slide-02').addClass('active');
    $('.webTraffic-data .slide-01').removeClass('active');
    $('.webTraffic-data .onSlide02').addClass('disabled');
    $('.webTraffic-data .onSlide01').removeClass('disabled');
      
  });
  $('.onSlide01').click(function(){
    console.log("onSlide02");
    $('.webTraffic-data .slide-01').addClass('active');
    $('.webTraffic-data .slide-02').removeClass('active');
    $('.webTraffic-data .onSlide01').addClass('disabled');
    $('.webTraffic-data .onSlide02').removeClass('disabled');
      
  });

  // $(".onPasswordInput").click(function(){
  //   $(".clientLoginInput, .onForgotPassword").removeClass("show");
  //   $(".clientLoginPassword, .onBackLoginInput").addClass("show");
  // });

  // $(".onForgotPassword").click(function(){
  //   $(".clientLoginInput , .clientLoginPassword").removeClass("show");
  //   $(".clientForgotPassword").addClass("show");
  // });

  // $(".onLoginInput").click(function(){
  //   $(".clientForgotPassword , .clientLoginPassword").removeClass("show");
  //   $(".clientLoginInput").addClass("show");
  // });

  $(".onBackLoginInput").click(function(){
    $('#clientpartner_password').val('');
    $(".clientLoginPassword , .onBackLoginInput").removeClass("show");
    $(".onForgotPassword, .clientLoginInput").addClass("show");
  ...
  $(".client-tab #tab-1").click(function(){
    $(".client-tab .tab-view-dsn").removeClass("active");
    $(".client-tab .tab-1-view").addClass("active");
    $(".client-tab #tab-2").removeClass("active");
    $(this).addClass("active");
  });

  $(".client-tab #tab-2").click(function(){
    $(".client-tab .tab-view-dsn").removeClass("active");
    $(".client-tab .tab-2-view").addClass("active");
    $(".client-tab #tab-1").removeClass("active");
    $(this).addClass("active");
  });
  ...
  $(".tab-title").click(function(){
    ...
    var clientParnetTabId = $(this).attr("id");
    $(".client-partner-block .tab-title, .client-partner-block .tab-detail, .tab-sidebar").removeClass("active");
    $("."+clientParnetTabId+"-view").addClass("active");
    $(this).addClass("active");
    $("."+clientParnetTabId+"-view-sidebar").addClass("active");  
    // console.log("."+clientParnetSubTabId+"-view")

    if(clientParnetTabId == "tab-3" || clientParnetTabId == "tab-5" || clientParnetTabId == "tab-6" || clientParnetTabId == "tab-7" || clientParnetTabId == "tab-4" ) {
      $('.client-partner-block').addClass('financial-roi');
    }else {
      $('.client-partner-block').removeClass('financial-roi');
    }

    if(clientParnetTabId == "tab-1") {
      if($('#service-1-tab-3').hasClass('active')) {
         $('.client-partner-block').addClass('financial-roi');
      }else {
         $('.client-partner-block').removeClass('financial-roi');
      }
  ...
  $(".sub-tab-title-1").click(function(){
  
    var clientParnetSubTabId = $(this).attr("id");
    $(".sub-tab-title-1, .sub-tab-detail-1").removeClass("active");
  ...
  $(".sub-tab-title-2").click(function(){
 
    var clientParnetSubTabId = $(this).attr("id");
    $(".sub-tab-title-2, .sub-tab-detail-2").removeClass("active");
    $("."+clientParnetSubTabId+"-view").addClass("active");
    $(this).addClass("active");
    // console.log("."+clientParnetSubTabId+"-view")
  });
  ...
  $(window).scroll(function () {
    // console.log("scroll");
    var scrollPositionToTrigger = 50; // Adjust this value as needed
  ...
  $(".grn-nav").click(function () {
    ...
    $(".home-fixed-nav-bar.supply-register").addClass("increase-zindex");
  });

  $(".nav-close-dsn .btn-close").click(function () {
    $(".sm-sec").removeClass("hide-sm");
    $(".home-fixed-nav-bar.supply-register").removeClassClass("increase-zindex");
  });
  ...
  $(".banner_img_sec").hover(function () {
    ...
    if($(this).hasClass('no-img')) {
      $('#home-slider .desk-nav').addClass('hovered');
      $('#home-slider .desk-nav img').attr('src', 'dist/images/sm/Menu.png');
    }else {
      $('#home-slider .desk-nav').removeClass('hovered');
      $('#home-slider .desk-nav img').attr('src', 'dist/images/sm/Group.png');
    }
  });
...
/*setInterval(function () {
  ...
  if ($(".project .flip-card-front").hasClass("active")) {
    setTimeout(function () {
      ...
      $(".project .flip-card-front").hover(function(){
        $(this).parent(".flip-card-inner").css("transform", "rotateY(180deg)");
        $(this).siblings(".flip-card-back").removeClass("active");
        $(this).addClass("active");
      });
    }, 1000);
  }
...
setInterval(function () {
  ...
  if ($(".project1 .flip-card-front").hasClass("active")) {
    setTimeout(function () {
      ...
      $(".project1 .flip-card-front").hover(function(){
        $(this).parent(".flip-card-inner").css("transform", "rotateY(180deg)");
        $(this).siblings(".flip-card-back").removeClass("active");
        $(this).addClass("active");
      });
...
setInterval(function () {
  ...
  if ($(".project2 .flip-card-front").hasClass("active")) {
    setTimeout(function () {
      ...
      $(".project2 .flip-card-front").hover(function(){
        $(this).parent(".flip-card-inner").css("transform", "rotateY(180deg)");
        $(this).siblings(".flip-card-back").removeClass("active");
        $(this).addClass("active");
      });
...
$(document).ready(function () {
  ...
  $(".onBacktoProduct").click(function () {
    $(
      ".banner-mob, #cleansec, #servicesec, .solutionMob, #productsec, #home-slider, #projectsec"
    ).removeClass("hide");
    $(".solutionDetailMob").removeClass("show");
    $(".menu-dot-list").removeClass("show");
    $("html, .wrapper").animate(
      {
  ...
  $(".image_left_1 .eng_view").click(function () {
    ...
    $("html, .wrapper").animate(
      {
        scrollTop: $(".header_section_eng").offset().top - 56,
      },
      500
    );
  });
